...
#  It is a standard whenever we have a variable related to file or a whole python file we use capital letters 
...
#  deamon is gracefully used to close your thread 
#  It is used to close our thread when we close the application
#  Now we don't need to mention join or something 
